...
document.getElementById('verificationName').addEventListener('submit', function(e) {
    ...
    // Validasi nama
    const validNames = ['sabikhisma', 'sabikhisma qolbu insani', 'Sabikhisma', 'Sabikhisma qolbu insani', 'kisma', 'Kisma'];
...
document.getElementById('verification').addEventListener('submit', function(e) {
    ...
    if (isPartner !== 'bustermoon') {
        Swal.fire({
            title: 'ooo gitu lebih pilih mori?😒',
            text: 'ku kasih kesempatan ulang dari awal',
            icon: 'warning',
        }).then(() => {
    ...
    Swal.fire({
        title: 'yayyy, ini baru percaya sihh',
        text: 'Selamat melihat🤩😘',
        icon: 'success',
    }).then(() => {
...
const animationTimeline = () => {
    ...
    // Arahkan ke halaman lain ketika elemen .last-smile diklik
document.querySelector(".last-smile").addEventListener("click", function () {
    window.location.href = "https://bustermoonn.github.io/sweet-potato/";
});
}
